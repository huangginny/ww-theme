			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						/*__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'ww-theme' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'ww-theme' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'ww_theme_post_thumbnail' ) ) :
	 ...
	 */
	function ww_theme_post_thumbnail() {
